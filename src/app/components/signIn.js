        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                className="mt-1 block w-full px-3 py-2 text-black border border-stone-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500"
                type="password"
                id="password"
                name="password"
